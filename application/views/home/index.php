      ...
      <div class="col-4 d-flex justify-content-end align-items-center">
        ...
        <?php 
          if(!empty($session['username'])){ 
            ...
            <!-- <div class="dropdown">
              <button class="btn btn-secondary dropdown-toggle" style="width: auto" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
